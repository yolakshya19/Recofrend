...
class PreferencesScreenbooks extends StatefulWidget {
  ...
  @override
  State<PreferencesScreenbooks> createState() => _PreferencesScreenbooksState();
}

class _PreferencesScreenbooksState extends State<PreferencesScreenbooks> {
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Select your favorite Books interests",
                          style: TextStyle(
                            fontSize: 25,
                            fontWeight: FontWeight.bold,
                          ),
