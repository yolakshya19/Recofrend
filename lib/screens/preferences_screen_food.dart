...
import 'package:recofrend/screens/preferences_screenGoOut.dart';

class PreferencesScreenfood extends StatefulWidget {
  const PreferencesScreenfood({super.key});

  @override
  State<PreferencesScreenfood> createState() => _PreferencesScreenfoodState();
}

class _PreferencesScreenfoodState extends State<PreferencesScreenfood> {
                ...
                children: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Select your favorite Food interests",
                          style: TextStyle(
                            fontSize: 25,
